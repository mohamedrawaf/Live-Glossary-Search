...
function glossary_settings_page() {
    add_options_page(__('Glossary Settings', 'glossary-plugin'), __('Glossary Settings', 'glossary-plugin'), 'manage_options', 'glossary_settings', 'glossary_settings_page_content');
}
...
function glossary_settings_page_content() {
    ...
    ?>
    <div class="wrap">
        <h2><?php esc_html_e('Glossary Plugin Settings', 'glossary-plugin'); ?></h2>
        <hr>
        <form method="post" action="options.php">
            ...
            ?>
            <h3><?php esc_html_e('Single Posts', 'glossary-plugin'); ?></h3>
            <label for="append_whatis_enabled">
                ...
                <?php esc_html_e('Append "What is" to post titles?', 'glossary-plugin'); ?>
            </label>
            <?php submit_button(); ?>
        </form>
    </div>
